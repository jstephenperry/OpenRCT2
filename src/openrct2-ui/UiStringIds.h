...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_PLUGIN_MANAGER_TITLE = 7033,
        STR_PLUGIN_MANAGER_TAB_INSTALLED = 7034,
        STR_PLUGIN_MANAGER_TAB_AVAILABLE = 7035,
        STR_PLUGIN_MANAGER_TAB_SOURCES = 7036,
        STR_PLUGIN_MANAGER_OPEN_FOLDER = 7037,
        STR_PLUGIN_MANAGER_UNINSTALL = 7038,
        STR_PLUGIN_MANAGER_INSTALL = 7039,
        STR_PLUGIN_MANAGER_REINSTALL = 7040,
        STR_PLUGIN_MANAGER_REFRESH = 7041,
        STR_PLUGIN_MANAGER_OPEN_WEBPAGE = 7042,
        STR_PLUGIN_MANAGER_ADD_SOURCE = 7043,
        STR_PLUGIN_MANAGER_REMOVE_SOURCE = 7044,
        STR_PLUGIN_MANAGER_ENTER_SOURCE_URL = 7045,
        STR_PLUGIN_MANAGER_X_INSTALLED = 7046,
        STR_PLUGIN_MANAGER_X_AVAILABLE = 7047,
        STR_PLUGIN_MANAGER_FETCHING = 7048,
        STR_PLUGIN_MANAGER_FETCH_FAILED = 7049,
        STR_PLUGIN_MANAGER_INSTALLING = 7050,
        STR_PLUGIN_MANAGER_INSTALL_SUCCESS = 7051,
        STR_PLUGIN_MANAGER_INSTALL_FAILED_TITLE = 7052,
        STR_PLUGIN_MANAGER_BUILTIN_SOURCE = 7053,
        STR_PLUGIN_MANAGER_SORT_STARS = 7054,
        STR_PLUGIN_MANAGER_SORT_RECENT = 7055,
        STR_PLUGIN_MANAGER_SORT_NAME = 7056,
        STR_PLUGIN_MANAGER_SEARCH_PROMPT = 7057,
        STR_PLUGIN_MANAGER_CONFIRM_INSTALL = 7058,
        STR_PLUGIN_MANAGER_UNVERIFIED_WARNING = 7059,
        STR_PLUGIN_MANAGER_CHECKING_RELEASE = 7060,
        STR_PLUGIN_MANAGER_NOT_INSTALLABLE = 7061,
