...
namespace OpenRCT2
{
    enum : StringId
    {
        ...
        STR_GUESTS_FILTER_AT_RIDE = 7035,
        STR_GUESTS_FILTER_BY_NAME = 6171,
        STR_GUESTS_FILTER_BY_NAME_TIP = 6172,
        STR_GUESTS_FILTER_HEADING_FOR_RIDE = 7037,
        STR_GUESTS_FILTER_IN_RIDE = 7034,
        STR_GUESTS_FILTER_ON_RIDE = 7033,
        STR_GUESTS_FILTER_QUEUING_FOR_RIDE = 7036,
